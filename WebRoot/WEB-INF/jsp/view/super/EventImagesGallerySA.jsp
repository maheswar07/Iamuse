...
<div id="gif" style="display: none;">
	<img src="https://www.willmaster.com/images/preload.gif">
		...
		<div class="right-pannel col-lg-10 col-xs-12 right-height">
					...
					<a href="eventReportDetailsSA?eventId=${optionsReports.eventId }"><button type="button" class="btn btn-default btn-sm pull-left" style="margin-right: 10px;margin-top: 7px;"><span class="glyphicon glyphicon-chevron-left"></span>Back</button></a><h1 class="heading pull-left">Event Gallery</h1>
