...
<div class="col-lg-2 col-md-3" style="width:20%;"></div>
		<div class="col-lg-10 col-xs-12 right-pannel" style="min-height:1006px;">
		<a href="publishNow?eid=${eid}"><input type="button" class="btn btn-green pull-right" value="Publish Now" style="width:auto;margin-right: 10px;margin-top:15px;" data-toggle="tooltip" title=""></a>
					...
					<div class="inner-content" style="padding:35px;">
						<div class="col-row">
								...
								<div class="form_row" style="margin-top:35px; margin-left:0px;" >									
								...
								<div class="upload-bg">
									...
									<div class="clearfix"></div>
									<a href="javascript:void(0)" class="btn btn-green event-create-bgpic"onclick="open3();">Choose Background(s) <br> From Library</a>
								</div>
									</div></div>
