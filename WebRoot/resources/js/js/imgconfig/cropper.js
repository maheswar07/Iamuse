...
/***/ function(module, exports) {
	...
	Object.defineProperty(exports, "__esModule", {
	 ...
	 exports.default = '<div id="cDiv" class="cropper-container">' + '<div class="cropper-wrap-box">' + '<div class="cropper-canvas"></div>' + '</div>' + '<div class="cropper-drag-box"></div>' + '<div id="cropperImageDiv" class="cropper-crop-box" title="This image is shown on Camera device while booth is idle. Typically should tell Guests to touch other device to start photobooth session. Image size should match Background sizes used in Event">' +'<img id="cropperImage" class="cropper-view-box" src="/iamuse/resources/images/images/zoom_profile2.png"></img>' + '<span class="cropper-dashed dashed-h"></span>' + '<span class="cropper-dashed dashed-v"></span>' + '<span class="cropper-center"></span>' + '<span class="cropper-face">    </span>' + '<span class="cropper-line line-e" data-action="e"></span>' + '<span class="cropper-line line-n" data-action="n"></span>' + '<span class="cropper-line line-w" data-action="w"></span>' + '<span class="cropper-line line-s" data-action="s"></span>' + '<span class="cropper-point point-ne" data-action="ne"></span>' + '<span class="cropper-point point-nw" data-action="nw"></span>' + '<span class="cropper-point point-sw" data-action="sw"></span>' + '<span class="cropper-point point-se" data-action="se"></span>' + '</div>' + '</div>';
/***/ },
/* 3 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  initCropBox: function initCropBox() {
	    ...
	    var gridShift=document.getElementById("gridShift").value;
	    if(gridShift=="")
	    	{
	    	 cropBoxDataleft1=0;//parseFloat(canvasData.left);
	    	}
	    else if(gridShift=="-1")
	    	{
	    	gridShift = (parseFloat(x)+parseFloat(canvasData.left));
	    	cropBoxDataleft1=(parseFloat(gridShift)+parseFloat(canvasData.left));
	    	}
	    else
	    	{
	    	 cropBoxDataleft1=(parseFloat(gridShift)+parseFloat(canvasData.left));
	    ...
	    cropBoxData.oldLeft =cropBoxData.left=cropBoxDataleft1;
	  ...
	  renderCropBox: function renderCropBox() {
	    ...
	    //cropBoxDataleft2=cropBoxData.left;
	   leftDiff1=(parseFloat(cropBoxData.left)-parseFloat(canvasData.left));
	    ...
	    leftDiff1=(parseFloat(cropBoxData.left)-parseFloat(canvasData.left));
		//cropBoxDataleft2=(parseFloat(leftDiff1)+parseFloat(canvasData.left));
	    document.getElementById("gridShift").value=leftDiff1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var REGEXP_ACTIONS = exports.REGEXP_ACTIONS = /^(se|sw|ne|nw|all|crop|move)$////^(e|w|s|n|se|sw|ne|nw|all|crop|move)$/;
...
//# sourceMappingURL=cropper.js.mapz